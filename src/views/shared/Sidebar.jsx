    ...
    return (
        ...
        <div>
            <nav className="sidebar">
                ...
                <ul id="sidebar_menu">
                    <li >
                        <NavLink exact to="/dashboard" activeClassName="mm-active">
                    ...
                    <li className="">
                        <NavLink  to="/account" activeClassName="mm-active">
                    ...
                    <li className="">
                        <NavLink  to="/transaction" activeClassName="mm-active">
                    ...
                    <li className="">
                        <NavLink  to="/Stock-rewards" activeClassName="mm-active">
                    ...
                    <li className="">
                        <NavLink  to="/Referral" activeClassName="mm-active">
                            <svg width="20" height="21" viewBox="0 0 20 21"  xmlns="http://www.w3.org/2000/svg">
                                <path
                                    d="M16 5.89258V8.89258M16 8.89258V11.8926M16 8.89258H19M16 8.89258H13M10.75 4.76758C10.75 6.63154 9.23896 8.14258 7.375 8.14258C5.51104 8.14258 4 6.63154 4 4.76758C4 2.90362 5.51104 1.39258 7.375 1.39258C9.23896 1.39258 10.75 2.90362 10.75 4.76758ZM1.00092 17.6269C1.00031 17.5905 1 17.5541 1 17.5176C1 13.9968 3.85418 11.1426 7.375 11.1426C10.8958 11.1426 13.75 13.9968 13.75 17.5176V17.5201C13.75 17.5558 13.7497 17.5914 13.7491 17.6269C11.8874 18.7478 9.70647 19.3926 7.375 19.3926C5.04353 19.3926 2.86264 18.7478 1.00092 17.6269Z"
                                     strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                    ...
                    <li className="sidebar-foot d-flex">
                       <NavLink  to="/messages" activeClassName="mm-active">
                ...
                <div class="profile-settings hide" id="openpopup_dropdown">
                            <ul>
                                <li>
                                    <NavLink  to="/account-documents" activeClassName="mm-active">
                                    <svg width="18" height="22" viewBox="0 0 18 22" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M16.5 13.25V10.625C16.5 8.76104 14.989 7.25 13.125 7.25H11.625C11.0037 7.25 10.5 6.74632 10.5 6.125V4.625C10.5 2.76104 8.98896 1.25 7.125 1.25H5.25M7.5 1.25H2.625C2.00368 1.25 1.5 1.75368 1.5 2.375V19.625C1.5 20.2463 2.00368 20.75 2.625 20.75H15.375C15.9963 20.75 16.5 20.2463 16.5 19.625V10.25C16.5 5.27944 12.4706 1.25 7.5 1.25Z"  stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                            </svg>
                                            Account documents
                                    </NavLink>
                                </li>
                                <li>
                                    <NavLink  to="/disclosures" activeClassName="mm-active">
                                        <svg width="20" height="22" viewBox="0 0 20 22" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M7 11.7506L9.25 14.0006L13 8.75058M10 1.71484C7.8495 3.75147 4.94563 5.00059 1.75 5.00059C1.69922 5.00059 1.64852 5.00028 1.59789 4.99965C1.2099 6.17976 1 7.44069 1 8.75064C1 14.3422 4.82432 19.0405 10 20.3726C15.1757 19.0405 19 14.3422 19 8.75064C19 7.44069 18.7901 6.17976 18.4021 4.99965C18.3515 5.00028 18.3008 5.00059 18.25 5.00059C15.0544 5.00059 12.1505 3.75147 10 1.71484Z" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                        </svg>
                                        Disclosures
                                    </NavLink>
                                </li>
                                ...
                                <li>
                                    <a>
                                        <svg width="19" height="20" viewBox="0 0 19 20" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M11.75 7V3.25C11.75 2.00736 10.7426 1 9.5 1L3.5 1C2.25736 1 1.25 2.00736 1.25 3.25L1.25 16.75C1.25 17.9926 2.25736 19 3.5 19H9.5C10.7426 19 11.75 17.9926 11.75 16.75V13M14.75 13L17.75 10M17.75 10L14.75 7M17.75 10L5 10" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                        </svg>
                                        SignOut
                                    </a>
                                </li>
        ...
        <div class="offcanvas custom-offcanvas offcanvas-end  contact-form" tabindex="-1" id="offcanvascontact"
            ...
            <div class="offcanvas-body p-4">
                    ...
                    <div class="contact-form row ">
                          <div class="col-md-12 mb-4">
                            <label for="validationCustom01" class="form-label">Object</label>
                    ...
                    <div class="btns">
                        <button className="btn-cancel btn btn-md btn-default" >Cancel</button>
                        <button className="btn-submit btn btn-md btn-primary">Send</button>
                    </div>
